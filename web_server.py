...
async def generate_story(request: StoryRequest):
    try:
        ...
        # Set topic and subtopic dynamically
        if request.topic and request.subtopic:
            generator.game_state.selected_concept = {
                "topic": request.topic,
                "subtopic": request.subtopic
            }
            print(f"Updated selected_concept: {generator.game_state.selected_concept}")
        else:
            print("Using default selected_concept:", generator.game_state.selected_concept)
